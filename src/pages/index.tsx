  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Empowering employers to manage employee data, vacations, and payroll with ease and efficiency."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Empowering employers to manage employee data, vacations, and payroll with ease and efficiency.`}
            </Text>
            <Box
